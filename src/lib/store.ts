...
export const getCommonItems = (): CommonItem[] => {
  ...
  const hardCodedItems: CommonItem[] = [
    // General Contracting
    { id: 'gc1', category: 'General Contracting - Site Prep & Protection', description: 'Floor & Furniture Protection', unit: 'sq ft', defaultUnitPrice: 1.5, isHardCoded: true },
    { id: 'gc2', category: 'General Contracting - Site Prep & Protection', description: 'Plastic Dust Barriers', unit: 'linear ft', defaultUnitPrice: 4.5, isHardCoded: true },
    { id: 'gc3', category: 'General Contracting - Management & Permits', description: 'Project Management Fee', unit: 'flat', defaultUnitPrice: 500, isHardCoded: true },
    { id: 'gc4', category: 'General Contracting - Management & Permits', description: 'Permit Coordination & Filing', unit: 'ea', defaultUnitPrice: 250, isHardCoded: true },
    { id: 'gc5', category: 'General Contracting - Cleanup & Disposal', description: 'Debris Removal (Small Load)', unit: 'load', defaultUnitPrice: 350, isHardCoded: true },
    { id: 'gc6', category: 'General Contracting - Cleanup & Disposal', description: 'Final Site Cleanup & Polish', unit: 'sq ft', defaultUnitPrice: 0.85, isHardCoded: true },
    
    // Electrical
    { id: 'el1', category: 'Electrical - Installation', description: 'Outlet/Switch Installation', unit: 'ea', defaultUnitPrice: 125, isHardCoded: true },
    { id: 'el2', category: 'Electrical - Installation', description: 'Light Fixture Installation', unit: 'ea', defaultUnitPrice: 150, isHardCoded: true },
    { id: 'el3', category: 'Electrical - Installation', description: 'Recessed Lighting (Single)', unit: 'ea', defaultUnitPrice: 185, isHardCoded: true },
    { id: 'el4', category: 'Electrical - Repair & Maintenance', description: 'GFCI Outlet Replacement', unit: 'ea', defaultUnitPrice: 175, isHardCoded: true },
    { id: 'el5', category: 'Electrical - Repair & Maintenance', description: 'Electrical Troubleshooting', unit: 'hr', defaultUnitPrice: 125, isHardCoded: true },
    { id: 'el6', category: 'Electrical - Upgrades', description: 'Electrical Panel Upgrade (200A)', unit: 'ea', defaultUnitPrice: 2500, isHardCoded: true },
    { id: 'el7', category: 'Electrical - Upgrades', description: 'EV Charger Circuit Installation', unit: 'ea', defaultUnitPrice: 850, isHardCoded: true },
    { id: 'el8', category: 'Electrical - Upgrades', description: 'Whole House Surge Protector', unit: 'ea', defaultUnitPrice: 450, isHardCoded: true },
    
    // Plumbing
    { id: 'pl1', category: 'Plumbing - Fixtures & Fittings', description: 'Faucet Installation', unit: 'ea', defaultUnitPrice: 175, isHardCoded: true },
    { id: 'pl2', category: 'Plumbing - Fixtures & Fittings', description: 'Toilet Replacement', unit: 'ea', defaultUnitPrice: 350, isHardCoded: true },
    { id: 'pl3', category: 'Plumbing - Fixtures & Fittings', description: 'Garbage Disposal Install', unit: 'ea', defaultUnitPrice: 225, isHardCoded: true },
    { id: 'pl4', category: 'Plumbing - Piping & Leaks', description: 'Leak Repair & Inspection', unit: 'ea', defaultUnitPrice: 250, isHardCoded: true },
    { id: 'pl5', category: 'Plumbing - Piping & Leaks', description: 'Pipe Section Replacement', unit: 'ea', defaultUnitPrice: 450, isHardCoded: true },
    { id: 'pl6', category: 'Plumbing - Water Heaters', description: 'Standard Tank Water Heater', unit: 'ea', defaultUnitPrice: 1800, isHardCoded: true },
    { id: 'pl7', category: 'Plumbing - Water Heaters', description: 'Tankless Water Heater', unit: 'ea', defaultUnitPrice: 3500, isHardCoded: true },
    { id: 'pl8', category: 'Plumbing - Drainage', description: 'Drain Cleaning (Main Line)', unit: 'ea', defaultUnitPrice: 450, isHardCoded: true },
    { id: 'pl9', category: 'Plumbing - Drainage', description: 'Sump Pump Replacement', unit: 'ea', defaultUnitPrice: 550, isHardCoded: true },
    
    // HVAC
    { id: 'hv1', category: 'HVAC - Cooling', description: 'AC System Tune-Up', unit: 'ea', defaultUnitPrice: 185, isHardCoded: true },
    { id: 'hv2', category: 'HVAC - Cooling', description: 'Condenser Fan Motor Replace', unit: 'ea', defaultUnitPrice: 450, isHardCoded: true },
    { id: 'hv3', category: 'HVAC - Heating', description: 'Furnace Inspection', unit: 'ea', defaultUnitPrice: 165, isHardCoded: true },
    { id: 'hv4', category: 'HVAC - Heating', description: 'Heat Pump Repair', unit: 'hr', defaultUnitPrice: 145, isHardCoded: true },
    { id: 'hv5', category: 'HVAC - Air Quality & Maintenance', description: 'Filter Replacement', unit: 'ea', defaultUnitPrice: 45, isHardCoded: true },
    { id: 'hv6', category: 'HVAC - Air Quality & Maintenance', description: 'Duct Cleaning Service', unit: 'ea', defaultUnitPrice: 650, isHardCoded: true },
    { id: 'hv7', category: 'HVAC - Air Quality & Maintenance', description: 'Thermostat Installation', unit: 'ea', defaultUnitPrice: 150, isHardCoded: true },
    
    // Landscaping
    { id: 'ls1', category: 'Landscaping - Maintenance', description: 'Lawn Mowing & Edging', unit: 'visit', defaultUnitPrice: 85, isHardCoded: true },
    { id: 'ls2', category: 'Landscaping - Maintenance', description: 'Sprinkler System Repair', unit: 'ea', defaultUnitPrice: 150, isHardCoded: true },
    { id: 'ls3', category: 'Landscaping - Hardscaping', description: 'Paver Patio Installation', unit: 'sq ft', defaultUnitPrice: 25, isHardCoded: true },
    { id: 'ls4', category: 'Landscaping - Hardscaping', description: 'Retaining Wall Construction', unit: 'sq ft', defaultUnitPrice: 45, isHardCoded: true },
    { id: 'ls5', category: 'Landscaping - Softscaping & Planting', description: 'Mulch Installation', unit: 'cu yd', defaultUnitPrice: 120, isHardCoded: true },
    { id: 'ls6', category: 'Landscaping - Softscaping & Planting', description: 'Tree/Shrub Planting', unit: 'ea', defaultUnitPrice: 250, isHardCoded: true },
    { id: 'ls7', category: 'Landscaping - Softscaping & Planting', description: 'Sod Installation', unit: 'sq ft', defaultUnitPrice: 2.25, isHardCoded: true },
