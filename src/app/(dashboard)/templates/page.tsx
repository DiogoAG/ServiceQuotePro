                        ...
                        <div className="space-y-8">
                          {groups.map((group, gIdx) => (
                            <div key={group.subName || gIdx} className="space-y-4">
                              ...
                              <div className="grid grid-cols-[1fr_80px_100px_40px] gap-4 px-2 text-[10px] font-bold text-muted-foreground uppercase tracking-widest mb-1">
                              ...
                              <div className="space-y-2">
                                {group.items.map((item) => (
                                  <div key={item.id} className="grid grid-cols-[1fr_80px_100px_40px] gap-4 items-center group">
